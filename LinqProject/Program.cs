...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Product{ProductId=1,CategoryId=1,ProductName="Acer Laptop 1", QuantityPerUnit="32 GB Ram", UnitPrice=10000,UnitInStock=5},
                new Product{ProductId=2,CategoryId=1,ProductName="Acer Laptop 2", QuantityPerUnit="16 GB Ram", UnitPrice=8000,UnitInStock=3},
